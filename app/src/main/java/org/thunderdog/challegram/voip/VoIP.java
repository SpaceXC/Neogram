...
public class VoIP {
    ...
    public static boolean isDebugOptionEnabled(@DebugOption int options) {
        return BitwiseUtilsKt.hasFlag(debugOptions, options);
    }

    public static void setDebugOptionEnabled(@DebugOption int option, boolean isEnabled) {
        debugOptions = BitwiseUtilsKt.setFlag(debugOptions, option, isEnabled);
    }
        ...
        for (TdApi.CallServer server : servers) {
            ...
            switch (server.type.getConstructor()) {
                ...
                default:
                    ...
                    throw new RuntimeException("Unsupported version of tgcall");
            }
    ...
    public static VoIPInstance instantiateAndConnect(
        ...
        final CallConfiguration configuration = new CallConfiguration(
                ...
                /*tdlib.callPacketTimeoutMs()*/30000,
                /*tdlib.callConnectTimeoutMs()*/10000,
                /*tdlib.files().getEffectiveVoipDataSavingOption()*/DataSavingOption.ALWAYS,
                forceTcp,
                proxy,
