...
fun toObject(members: List<JsonObjectMember>): JsonValueObject =
    JsonValueObject(members.toTypedArray())

fun toObject(members: Map<String, Any?>): JsonValueObject =
    toObject(members.map { JsonObjectMember(it.key, toValue(it.value)) })
