...
@Autogenerated
fun AnimatedChatPhoto?.equalsTo(other: AnimatedChatPhoto?): Boolean =
    this.safeEqualsTo(other) { b ->
        if (COMPILE_CHECK) {
            AnimatedChatPhoto(
                this.length,
                this.file,
...
@Autogenerated
fun ChatAdministratorRights?.equalsTo(other: ChatAdministratorRights?): Boolean =
    this.safeEqualsTo(other) { b ->
        if (COMPILE_CHECK) {
...
@Autogenerated
fun InlineKeyboardButton?.equalsTo(other: InlineKeyboardButton?): Boolean =
    this.safeEqualsTo(other) { b ->
        if (COMPILE_CHECK) {
...
@Autogenerated
fun ProfileAccentColor?.equalsTo(other: ProfileAccentColor?): Boolean =
    this.safeEqualsTo(other) { b ->
        if (COMPILE_CHECK) {
            ProfileAccentColor(
                this.id,
...
@Autogenerated
fun ProfileAccentColors?.equalsTo(other: ProfileAccentColors?): Boolean =
    this.safeEqualsTo(other) { b ->
        if (COMPILE_CHECK) {
            ProfileAccentColors(
                this.paletteColors,
...
@Autogenerated
fun UpgradedGiftBackdrop?.equalsTo(other: UpgradedGiftBackdrop?): Boolean =
    this.safeEqualsTo(other) { b ->
        if (COMPILE_CHECK) {
...
@Autogenerated
fun UpgradedGiftBackdropColors?.equalsTo(other: UpgradedGiftBackdropColors?): Boolean =
    this.safeEqualsTo(other) { b ->
        if (COMPILE_CHECK) {
...
@Autogenerated
fun UpgradedGiftModel?.equalsTo(other: UpgradedGiftModel?): Boolean =
    this.safeEqualsTo(other) { b ->
        if (COMPILE_CHECK) {
            UpgradedGiftModel(
                this.name,
...
@OptIn(ExperimentalContracts::class)
@Autogenerated
fun UpgradedGiftOriginalDetails?.equalsTo(other: UpgradedGiftOriginalDetails?): Boolean =
    this.safeEqualsTo(other) { b ->
        if (COMPILE_CHECK) {
...
@Autogenerated
fun UpgradedGiftSymbol?.equalsTo(other: UpgradedGiftSymbol?): Boolean =
    this.safeEqualsTo(other) { b ->
        if (COMPILE_CHECK) {
            UpgradedGiftSymbol(
                this.name,
...
@Autogenerated
fun CanSendMessageToUserResult?.equalsTo(other: CanSendMessageToUserResult?): Boolean =
    this.safeEqualsTo(other) { b ->
        when (this.constructor) {
...
@Autogenerated
fun ChatPhotoStickerType?.equalsTo(other: ChatPhotoStickerType?): Boolean =
    this.safeEqualsTo(other) { b ->
        when (this.constructor) {
...
@Autogenerated
fun InlineKeyboardButtonType?.equalsTo(other: InlineKeyboardButtonType?): Boolean =
    this.safeEqualsTo(other) { b ->
        when (this.constructor) {
...
@Autogenerated
fun InviteLinkChatType?.equalsTo(other: InviteLinkChatType?): Boolean =
    this.safeEqualsTo(other) { _ ->
        when (this.constructor) {
...
@Autogenerated
fun KeyboardButtonType?.equalsTo(other: KeyboardButtonType?): Boolean =
    this.safeEqualsTo(other) { b ->
        when (this.constructor) {
...
@Autogenerated
fun LinkPreviewAlbumMedia?.equalsTo(other: LinkPreviewAlbumMedia?): Boolean =
    this.safeEqualsTo(other) { b ->
        when (this.constructor) {
...
@Autogenerated
fun MessageSelfDestructType?.equalsTo(other: MessageSelfDestructType?): Boolean =
    this.safeEqualsTo(other) { b ->
        when (this.constructor) {
...
@Autogenerated
fun SpeechRecognitionResult?.equalsTo(other: SpeechRecognitionResult?): Boolean =
    this.safeEqualsTo(other) { b ->
        when (this.constructor) {
...
@Autogenerated
fun UserPrivacySettingRule?.equalsTo(other: UserPrivacySettingRule?): Boolean =
    this.safeEqualsTo(other) { b ->
        when (this.constructor) {
...
@Autogenerated
fun VectorPathCommand?.equalsTo(other: VectorPathCommand?): Boolean =
    this.safeEqualsTo(other) { b ->
        when (this.constructor) {
